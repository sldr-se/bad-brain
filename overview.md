...
Email](./comms/260212-1325-initial-email-corrected.md)), asking both about the
version discrepancies and the undisclosed telemetry, as well as where I might
find the source code for the SDK --- it's marked as being under Apache 2.0, but
I can't find its source anywhere. I also had Claude weed through the
...
reply](./comms/260213-0049-memvid-reply-corrected.md) conveniently not
